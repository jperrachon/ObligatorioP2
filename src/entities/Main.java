...
public class Main {
    public static void main(String[] args) {
        ...
        dataset.cargarDatosDesdeCSV("Obligatorio/src/dataset.csv");
        // Lógica adicional para probar la carga del archivo
        for (Pais pais : dataset.getPaises()) {
            System.out.println("País: " + pais.getNombre());
            for (String fecha : pais.getTop50PorFecha().keySet()) {
                System.out.println("Fecha: " + fecha);
                for (Cancion cancion : pais.getTop50PorFecha().get(fecha)) {
                    System.out.println("Canción: " + cancion.getNombre() + ", Artista: " + cancion.getArtista());
                }
            }
